...
const firstColumn = data.markdownRemark.frontmatter.gallery.slice(0, 2)
const secondColumn = data.markdownRemark.frontmatter.gallery.slice(3, 5)
const fullRow = data.markdownRemark.frontmatter.gallery.slice(5)
